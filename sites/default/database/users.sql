-- MySQL dump 10.11
--
-- Host: localhost    Database: drupalmel
-- ------------------------------------------------------
-- Server version	5.0.77-d8-ourdelta54-log
...
INSERT INTO `users` VALUES
  ...
  (1,'ADMIN-USER-NAME',MD5('ADMIN-USER-PASSWORD'),'ADMIN-USER-EMAIL',0,0,0,'','',0,1266321598,1276299604,1276299604,1,'36000','','','ADMIN-USER-EMAIL','a:0:{}','Australia/Melbourne');
