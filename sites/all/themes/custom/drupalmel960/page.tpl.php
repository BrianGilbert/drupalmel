...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="dmelmenu-outer">
  	<div id="dmelmenu-inner" class="drupmelmenu container-16 ">
	<?php if ($drupmelmenu): ?>
      <div id="drupmelmenu-region" class="region <?php print ns('grid-16', $mission, 7); ?> clear-block">
        <?php print $drupmelmenu; ?>
      </div>
    <?php endif; ?>
  		</div>
  	</div>
...
<div id="footer-outer" class="clear-block">
	<div id="footer-inner">
	<div id="dmelfooter" class="container-16 clear-block">	
